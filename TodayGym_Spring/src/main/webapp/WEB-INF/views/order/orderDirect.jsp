			...
			<div class="content-myOrder">
				<div class="myOrder-form">
					...
					<div class="myOrder-contents">
						...
						<div class="myOrder-contents-direct-orderlist">
							...
							<div class="contents-orderlist-price"><fmt:formatNumber type="number" maxFractionDigits="3" value="${myOrder.o_price}"/> 원</div>					
						</div>
